...
> **Note:** This endpoint is a regular API route protected by `LEMONADE_API_KEY` when a key is configured. It does not require the admin key. See [API Key and Security](../guide/configuration/README.md#api-key-and-security).
