...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td rowspan="3"><code>geniex-llamacpp</code> (experimental)</td>
      <td><code>npu</code></td>
      <td>Qualcomm Hexagon NPU (Snapdragon)</td>
      <td>Linux</td>
    </tr>
    <tr>
      <td><code>gpu</code></td>
      <td>Qualcomm Adreno GPU (Snapdragon)</td>
      <td>Linux</td>
    </tr>
    <tr>
      <td><code>cpu</code></td>
      <td>ARM64 CPU (Snapdragon)</td>
      <td>Linux</td>
    </tr>
    <tr>
